          ...
          {user ? (
            ...
            >
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
                Your Journey Begins with <span className="text-gradient">Beacon Planner</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Button
                  ...
                  className="min-w-[200px] text-lg py-6 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm group cursor-pointer"
                >
                  Start Planning
