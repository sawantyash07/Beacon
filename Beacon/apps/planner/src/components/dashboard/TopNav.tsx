    ...
    <header className="sticky top-0 z-30 glass border-b border-border px-4 py-3">
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <div className="w-full pl-10 pr-4 py-2 rounded-[12px] border border-border bg-page/50 group-hover:bg-white text-sm text-muted flex items-center justify-between transition-all">
