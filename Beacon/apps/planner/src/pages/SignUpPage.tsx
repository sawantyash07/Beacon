              ...
              {step === 2 && (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="gender" className="text-xs font-semibold text-white/90 mb-1.5 block">Gender</label>
                      <select
                        id="gender"
                  ...
                  <div className="pt-2">
                    <label htmlFor="accept-terms" className="flex items-start gap-2.5 text-xs text-white/80 cursor-pointer">
                      <input
                        id="accept-terms"
                        type="checkbox"
                  ...
                  <div className="flex gap-3 mt-2">
                    <Button
                      ...
                      variant="outline"
                      onClick={() => setStep(1)}
                      className="border-white/20 text-white hover:bg-white/10 font-bold py-3.5 rounded-[14px]"
                    >
                      <ArrowLeft className="w-4 h-4 mr-1.5" /> Back
                    </Button>
                    <Button type="submit" className="flex-1 bg-cyan hover:bg-cyan/90 text-navy font-bold py-3.5 rounded-[14px] shadow-lg cursor-pointer flex justify-center items-center" disabled={loading}>
                      {loading ? (
                        <>
