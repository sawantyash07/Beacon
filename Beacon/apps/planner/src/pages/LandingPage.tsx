      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Button variant="ghost" className="text-sm text-white/80 hover:text-white hover:bg-white/5 font-semibold py-2.5" onClick={handleBecomePlanner}>
              Login
            </Button>
            <Button glow className="text-sm font-bold bg-cyan text-navy px-5 py-2.5 rounded-[12px]" onClick={handleBecomePlanner}>
              Sign Up
            </Button>
          </div>
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-6 py-6 space-y-4 flex flex-col">
                ...
                <Button variant="outline" className="w-full justify-center py-3 border-white/10 text-white hover:bg-white/5" onClick={() => { handleBecomePlanner(); setMobileMenuOpen(false); }}>
                  Login
                </Button>
                <Button glow className="w-full justify-center py-3 bg-cyan text-navy font-bold rounded-[12px]" onClick={() => { handleBecomePlanner(); setMobileMenuOpen(false); }}>
                  Sign Up
                </Button>
              </div>
            </motion.div>
